var NuevasOportunidadesTabla = function() {
    ...
    var url = 'index.php?entryPoint=actualizartabla_new';
        ...
        cargarTabla: function() {
            if (!$.fn.dataTable.isDataTable('#table-3')) {
                ...
                NuevasOportunidadesTabla.nueva_oportunidades = $('#table-3').dataTable({
                    ajax: {
                        'url': 'index.php?entryPoint=actualizartabla_new',
                        'dataSrc': function(json_response) {
                            ...
                            for (i = 0; i < json.length; i++) {
								...
								json[i].agente;
								json[i].id_agente_c;
							    json[i].agente = ((json[i].agente == "") && (json[i].id_agente_c.trim()  == "")  ||  (json[i].agente == null) || 
...
function combo(option) 
{
	...
	{
		url = "index.php?entryPoint=actualizar_new&opc=2";
	...
	{
		url = "index.php?entryPoint=actualizar_new&opc=3";
	...
	{
		url = "index.php?entryPoint=actualizar_new&opc=4";
...
function asignar() {
    ...
    if (typeof(document.getElementById('ruta').value) != 'undefined' && document.getElementById('ruta').value != null) {
        ...
        url_ruta = ruta + '/index.php?entryPoint=grabaoportunidades_new';
    }
...
function  modal_asignar_ejecutivo (el){
	...
	url_ruta = 'http://backend.cochadigital.com/index.php?entryPoint=grabaoportunidades_new';
	//url_ruta = 'http://desa-backend.cochadigital.com/index.php?entryPoint=grabaoportunidades';
