				   ...
				   <TD WIDTH='100%'> 
					...
					<br>
					  <form class="form-horizontal">
						...
						<br><br>
						 <div class="form-group">
							 <div class="col-xs-offset-5 col-xs-10" style="margin-top:10px;">
								 <input type="button" class="btn btn-primary" id="asignar_ejecutivos" style="background-color:#21A9E1;" value="Asignar">
								  <input type="button" class="btn btn-primary" id="close" style="background-color:#21A9E1;" value="Cerrar">
							 </div>
						 </div>
					   </form>
				        </TABLE>
