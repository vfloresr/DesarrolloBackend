               ...
               <div class="row" >
                  <div class="col-md-5 form-inline">
                     ...
                     <select class="form-control" id="selectEjecutivos"> 
                        ...
                        <option id="opc2"   value ="opc2">Ejecutivos Externos</option>
	...
	<DIV id="popup" style="display: none;">
	  <form  name="form_asignacion" id="form_asignacion"  method="POST" >	
		<div class="content-popup" style="background-color:#E6E6E6;">
			<input id='ruta_modal' type = 'hidden' value= '<?php echo $sugar_config['site_url'] ?>'></input>
      ...
      <?php include ('custom/application/asignador/scripts_High.php');  ?>
   </body>
</html>